...
# R --slave --vanilla --args  png_pre dir < /Users/tang58/scripts_all/R_scripts/methlevel_over_TE_Gene_feature/gene_TE_bin_files_R_cmd_most_used_modified_for_space_cmd_input.r
# 1   2        3         4       5          6
...
par(xpd=NA)
legend(-250, -1,legend= x_lables , col = cols, lwd = 3, bty = "n",  cex = 2
,   ncol = length,
