...
jpeg("new_at3g14980.jpg",width = 580, height = 680)
data = read.table("at3g14980_bed.csv",sep=",")
...
{
	if(data[i,1] =="chr1")
	{lines(c(1.2,1.4),c(-data[i,2],-data[i,2]),lwd = 0.5)}
	
	if(data[i,1] =="chr2")
	{lines(c(2.2,2.4),c(-data[i,2],-data[i,2]),lwd = 0.5)}
	
	if(data[i,1] =="chr3")
	{lines(c(3.2,3.4),c(-data[i,2],-data[i,2]),lwd = 0.5)}
	
	if(data[i,1] =="chr4")
	{lines(c(4.2,4.4),c(-data[i,2],-data[i,2]),lwd = 0.5)}
	
	if(data[i,1] =="chr5")
	{lines(c(5.2,5.4),c(-data[i,2],-data[i,2]),lwd = 0.5)}
