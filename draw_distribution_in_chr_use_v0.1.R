...
#  setwd("/Users/tang58/misc/Mingguang_Lei/paper/edm2/list_for_dist/hyper")
#  source("/Users/tang58/scripts_all/R_scripts/draw_distribution_in_chr_use_v0.1.R")
...
file_name = paste("edm2Paper_DMR_dist_hyper", "_w", width_val, "_h", height_val, "_res", res_val, "_pt", pointsize_val, ".png", sep="")
