# R --slave --vanilla --args   input_list  png_pre < /Users/tang58/scripts_all/R_scripts/draw_loci_distribution_in_5_chr/draw_distribution_in_chr_use_coor_format_single_file_v0.2.R
...
#	chr = paste("chr", j, sep="");
	chr = i
	data = x [x[, 3] == chr, ];
	segments(i+0.2, -data[,4], i+0.4, -data[,4], lwd = thin_lwd)
