#!/usr/bin/R
# R --slave --vanilla --args  png_pre  indir </Users/tang58/scripts_all/R_scripts/draw_loci_distribution_in_5_chr/draw_distribution_in_chr_use_bed_format_multiple_input_v0.2.R


# v0.2 use  segments function
