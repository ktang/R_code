...
my $usage = "$0 <bed_dir> <IP_bed> <soapdir> <ctrl_soap_name> <crlt_resize_length>";
...
my $cmd = "time R --slave --vanilla --args " . $ctrl_soap . " " . $length . " " . $output . " ". $dir . " ". $ip_bed . " ". $soapdir ." < ./get_bed_region_coverage_v2.R";
