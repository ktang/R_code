...
# v1.2 every figure use Col-0 as Control

col0 = read.table("/Users/tang58/deep_seq_analysis/Bisulfite/work_with_Liu/dir_task_4/JKZ1_Col0_50kb_stat.txt",header=T,sep="\t")
# rdd = read.table("/Users/tang58/deep_seq_analysis/Bisulfite/work_with_Liu/dir_task_4/JKZ_17_rdd_50kb_stat.txt",header=T,sep="\t")
args = commandArgs()
...
#############################
		lines(subdata_col0[,1],subdata_col0[,2], type = "l", col =cols_col0[j])
		lines(subdata_col0[,1],subdata_col0[,3]*-1, type = "l", col =cols_col0[j])
###########################
